```
---
name: excelencia-en-revision-de-codigo
description: Domina las prácticas de revisión de código efectivas para proporcionar feedback constructivo, detectar errores tempranamente y fomentar el intercambio de conocimientos.
user-invocable: true
risk: safe
